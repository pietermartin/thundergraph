 ...
 * Time: 10:37 AM
 */
public abstract class BaseFromVertexIterator<E extends ThunderElement> extends BaseThunderIterator implements Iterator {

    public BaseFromVertexIterator(TransactionAndCursor tc) {
        super(tc);
    }
