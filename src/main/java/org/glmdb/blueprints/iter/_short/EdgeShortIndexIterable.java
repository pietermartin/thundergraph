 ...
 * Time: 10:22 AM
 */
public class EdgeShortIndexIterable<T extends Vertex> implements Iterable<ThunderEdge> {
    ...
    private final class EdgeShortIndexIterator implements Iterator<ThunderEdge> {
        ...
        public EdgeShortIndexIterator() {
            ...
            EdgeShortIndexIterable.this.tc.addIteratorCursor(this.edgeStringIndexDbCursor);
            ...
            EdgeShortIndexIterable.this.tc.addIteratorCursor(this.edgeDbCursor);
        }
